        ...
        <div>
          <ul>
            ...
            <li>
              <h4>Deaths</h4>
              <p>
                {{profileData.segments[0].stats.deaths.displayValue}}
                <span>({{profileData.segments[0].stats.deaths.percentile}}%)</span>
              </p>
            </li>
            <li>
              <h4>K/D</h4>
              <p>
                ...
                <span>({{profileData.segments[0].stats.kd.percentile}}%)</span>
              </p>
            </li>
          </ul>
        </div>
